...
//        AgentForwardSupport agentForward = service.getAgentForwardSupport();
        AgentForwardSupport agentForward = ((ServerConnectionService)service).getAgentForwardSupport();
    ...
    protected RequestHandler.Result handleX11Forwarding(String requestType, Buffer buffer, boolean wantReply) throws IOException {
        ...
        X11ForwardSupport x11Forward = ((ServerConnectionService)service).getX11ForwardSupport();
