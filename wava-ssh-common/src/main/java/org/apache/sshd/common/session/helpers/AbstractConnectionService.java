...
//    private final AtomicReference<X11ForwardSupport> x11ForwardHolder = new AtomicReference<>();
  protected final AtomicReference<AgentForwardSupport> agentForwardHolder = new AtomicReference<>();
  protected final AtomicReference<X11ForwardSupport> x11ForwardHolder = new AtomicReference<>();
